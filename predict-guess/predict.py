"""
Link: https://raw.githubusercontent.com/sympy/sympy/master/sympy/concrete/guess.py
"""
...
def predict_next_integers(integer_array):
    r = guess(integer_array, niter=4)
    i0 = symbols("i0")
    prediction = [r[0].subs(i0,n).doit() for n in range(1,10)]
